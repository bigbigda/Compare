...
lasagne.layers.set_all_param_values(cnn,data[0:54])
...
gtest = gtest_fn(x_train[0:50],y_train[0:50])

W_grads = binary_net.compute_grads(test_loss,cnn)
wtest_fn = theano.function([input,target],W_grads)
wtest = wtest_fn(x_train[0:50],y_train[0:50])
